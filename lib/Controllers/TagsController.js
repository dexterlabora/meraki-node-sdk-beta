...
class TagsController {
     ...
     * @param {string} input['type'] (optional) Filter the results by the tag type
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getNetworkSmTags(input, callback) {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {CreateNetworkSmTagModel} input['createNetworkSmTag'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static createNetworkSmTag(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.createNetworkSmTag === null || input.createNetworkSmTag === undefined) {
            const _err = { errorMessage: 'The property `createNetworkSmTag` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {string} input['type'] The type of the tag. Required.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['tagId'] TODO: type description here
     * @param {UpdateNetworkSmTagModel} input['updateNetworkSmTag'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static updateNetworkSmTag(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.updateNetworkSmTag === null || input.updateNetworkSmTag === undefined) {
            const _err = { errorMessage: 'The property `updateNetworkSmTag` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {string} input['tagId'] TODO: type description here
     * @param {string} input['type'] The type of the tag. Required.
     * @param {string} input['scope'] (optional) The scope and tag options of the target group.
     * Comma separated values beginning with one of withAny, withAll,
     ...
     * @returns {Promise}
     */
    static getNetworkSmTagScopedDevices(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/sm/tags/{tagId}/scopedDevices';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId: input.networkId,
            tagId: input.tagId,
